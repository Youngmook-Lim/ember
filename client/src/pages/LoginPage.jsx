function LoginPage() {
  const handleLogin = () => {
    // Redirects the browser to our backend's Google OAuth route.
    // The backend handles the entire OAuth flow and redirects back on success.
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-peach via-cream to-lavender px-6">
      <div className="text-center max-w-md mx-auto">
        ...
        >
          ...
          <span className="text-warm-gray font-semibold text-sm sm:text-base">
